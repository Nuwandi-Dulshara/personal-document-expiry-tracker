...
public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DocumentCategory>().HasData(
            new DocumentCategory { Id = 1, Name = "Passport" },
            new DocumentCategory { Id = 2, Name = "Driving Licence" },
            new DocumentCategory { Id = 3, Name = "Insurance" },
            new DocumentCategory { Id = 4, Name = "Certificate" },
            new DocumentCategory { Id = 5, Name = "Vehicle Document" },
            new DocumentCategory { Id = 6, Name = "Professional Licence" },
            new DocumentCategory { Id = 7, Name = "Warranty" },
            new DocumentCategory { Id = 8, Name = "Membership" },
            new DocumentCategory { Id = 9, Name = "Other" });
    }
}